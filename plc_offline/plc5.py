...
from logicblock_offline.logicblock import *
from controlblock_offline.controlblock import *
...
class plc5:
	...
	def Pre_Main_High_Pressure_RO(self,IO,HMI):
...
#Main
		...
		while switch(HMI.P5.State):
			...
			if case(21):
				...
				HMI.Cy_P5.MV501_TIMEOUT_TM		=0
				HMI.Cy_P5.MV502_TIMEOUT_TM		=0
				if HMI.MV503.Status==1 and HMI.Cy_P5.MV504.Status==1 or self.Mid_NEXT or HMI.Cy_P5.MV503_TIMEOUT_TM >120 or HMI.Cy_P5.MV504_TIMEOUT_TM >120 :
					HMI.P5.State=1
				break
			HMI.P5.State=1
			break
